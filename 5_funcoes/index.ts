...
function mergeObejcts<U, T> (obj1: U, obj2:T){
...
function modernGretting(name: string, greet?:string){
...
function showErrorMessage(msg:string): never //ou void
{
    throw new Error(msg)
}
...
function ShowProdutcDetails({name, price}:{name: string, price: number}):string{
